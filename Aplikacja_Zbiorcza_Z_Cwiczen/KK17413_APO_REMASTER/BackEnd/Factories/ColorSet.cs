...
namespace KK17413_APO_REMASTER.BackEnd.Factories
{
    ...
    class WFBright_ColorSet : ColorSet
    {
    ...
    class Trevilam_ColorSet : ColorSet
    {
    ...
    class FishBonesTheme_ColorSet : ColorSet
    {
    ...
    class VulturTheme_ColorSet : ColorSet
    {
