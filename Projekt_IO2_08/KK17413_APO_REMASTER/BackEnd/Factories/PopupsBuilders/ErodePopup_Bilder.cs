...
{
    class ErodePopup_Bilder : IPopupBuilder
    {
        public override IPopup GetResult()
        {
            ...
            ErodePopup result = new ErodePopup
            {
                form = new Form(),
                ...
                apertureSize_Text = new Label() { Text = "Iterations:" },
    ...
    class ErodePopup : IPopup
    {
        ...
        public override void Start(Program program, ImageForm_Service service, IOperation operation, string operationName)
        {
            ...
            apertureSize.Maximum = 128;
            apertureSize.Minimum = 0;
